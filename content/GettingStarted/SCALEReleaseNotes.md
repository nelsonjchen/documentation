...
* Some users report SATA SSD drive temperatures are not visible on the **Reporting** screen ([NAS-127524](https://ixsystems.atlassian.net/browse/NAS-127524)). If you experience this issue, go to **System Settings > Services**, locate the **S.M.A.R.T.** service row and click <i class="material-icons" aria-hidden="true" title="Configure">edit</i> to open the **S.M.A.R.T. General Options** screen. Set **Check Interval** to 30 or lower.
